...
class Coronavirus():
    ...
    def get_data(self):
        try:
            self.driver.get('https://www.worldmeters.info/coronavirus/')
            ...
            send_mail(country_element.text, total_cases, new_cases, total_deaths, new_deaths, active_cases,
...
def send_mail(country_element, total_cases, new_cases, total_deaths, new_deaths, active_cases, total_recovered,
    ...
    server.login('technohall.queries@gmail.com', 'wehavebrains@3')
